...
namespace Movies.API.Data
{
	...
	{
		public MoviesContextSeed() { }
        public static void SeedAsync(IServiceProvider serviceProvider)
		{
			using (var movieDbContext = new MoviesAPIContext(serviceProvider.GetRequiredService<DbContextOptions<MoviesAPIContext>>()))
			{
                    ...
                    var movies = new List<Movie>
                {
                    ...
                    movieDbContext.Movie.AddRange(movies);
